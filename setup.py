...
def prepare_modules():
    ...
    import numpy as np
    module_opts = { 'include_dirs' : [np.get_include()],
                    'extra_compile_args' : ["-ffast-math","-fno-finite-math-only", "-ftree-vectorize"]
                  }
    kwargs = {m : module_opts for m in modules}
    kwargs['move']['extra_compile_args'].append("-std=gnu89")
